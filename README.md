...
- Fase 3 iniciada: extracción de repositorios de infraestructura y primeros contratos de dominio para reducir dicts sueltos alrededor del pipeline legado.
