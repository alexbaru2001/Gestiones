...
- Fase 3 en curso: extracción de repositorios de infraestructura y contratos de dominio (`PipelineConfig`, `ObjectiveConfig`) para reducir dicts sueltos alrededor del pipeline legado.
